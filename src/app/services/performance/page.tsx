          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className={`flex flex-col items-center bg-gray-50 p-8 rounded-xl shadow-md transform transition-all duration-1000 hover:shadow-lg ${
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className={`transform transition-all duration-1000 delay-300 ${
                ...
                <div className="mb-8">
                  <h2 className="text-3xl font-bold mb-6">Indeedとは?</h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              {steps.map((step, index) => (
                <div 
                  key={index} 
                  className={`bg-white rounded-xl shadow-lg p-6 flex transform transition-all duration-700 hover:shadow-xl hover:-translate-y-1 ${
                    isIntersecting['process-section'] ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                  }`}
                  style={{ transitionDelay: `${index * 200}ms` }}
                >
